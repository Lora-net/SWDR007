...
static const sl_cli_command_info_t cli_cmd__get_time = \
  SL_CLI_COMMAND(cli_get_time,
                 "Gets current time",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__get_mtu = \
  SL_CLI_COMMAND(cli_get_mtu,
                 "Gets current MTU",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__switch_link = \
  SL_CLI_COMMAND(cli_link_switch,
                 "Switch between BLE/FSK/CSS depending on available radio links",
                  "",
                 {SL_CLI_ARG_END, });
